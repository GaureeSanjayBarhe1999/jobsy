...
const psqlConfig = 'postgres://postgres:Kajal@1999@127.0.0.1:5432/postgres';
const pool = new Pool({
...
export const insertLoginUser = async(mobile, name, email, college, city, gender) => {
   ...
   insertLoginUser(9846560000,"iswarya","iswarya@gmail.com","Dayanada sagar","banglore","female");
   insertLoginUser(90000565613,"iswarya","iswarya@gmail.com"," sagar","banor","female");
   insertLoginUser(98400000613,"iswarya","iswarya@gmail.com","Dayanada ","lohore","female");
   /**/ 
